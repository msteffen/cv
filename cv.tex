...
\begin{onecolentry}
    \begin{highlights}
        \item Pachyderm is a distributed filesystem with versioning, for data and AI pipelines. When a pipeline runs on Pachyderm data, our pipeline orchestrator uses versioning data to processes only new and updated shards. Results from unchanged shards are re-used, cutting the runtime and cost of our customers' pipelines by over 90\% in some cases. We described ourselves as ``Git for data'' or, sometimes, ``Bazel for data''.
