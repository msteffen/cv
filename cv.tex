...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Co-managed a team of seven engineers, after HPE re-organized Pachyderm into this single team in June 2024. To align the disparate teams being combined and trim unnecessary legacy process, I rewrote our engineering handbook and worked with HPE IT to implement a common development environment. Overall efficiency improved, and we shipped several long-backlogged features.
    \end{highlights}
\end{onecolentry}
...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Started new Integrations Team, to connect Pachyderm and other AI/ML products (Kubeflow, Seldon, LabelStudio, AzureML, and others). I acted as tech lead through its growth to five engineers.
    \end{highlights}
  \end{onecolentry}
